export const translations = {
  de: {
    projects: {
      ...
      linkApp: {
        title: "Link App",
        description: "Mit dieser App können Sie Links speichern, löschen und optional bearbeiten. Letztendlich dient die App dem Zweck, Websites einfach zu speichern und darauf zuzugreifen."
      },
      penAndPaper: {
        title: "Pen and Paper Storage System",
        description: "Diese Anwendung ist exklusiv für Windows und ermöglicht es Benutzern, Daten über Charaktere und Geschichten mit dem JSON-Speichersystem zu erstellen, zu bearbeiten und zu löschen."
      },
      portfolio: {
      ...
      exampleLibrary: {
        ...
        description: "Dieses Projekt ist eine umfassende Code-Beispielbibliothek, die Java, Python, Ruby, C/C++ und Webentwicklung (HTML, CSS, JavaScript mit React) abdeckt."
      },
      learnProgramming: {
  ...
  en: {
    projects: {
      ...
      linkApp: {
        title: "Link App",
        description: "Using this app, you can store, delete, and optionally edit links. Ultimately, the app serves the purpose of easily saving and accessing websites."
      },
      penAndPaper: {
        title: "Pen and Paper Storage System",
        description: "This application is exclusive to Windows and allows users to create, edit, and delete data about characters and stories using the JSON storage system."
      },
      portfolio: {
        title: "Portfolio Website",
      ...
      exampleLibrary: {
        title: "Example Library",
        description: "This project is a comprehensive code sample library covering Java, Python, Ruby, C/C++, and Web Development (HTML, CSS, JavaScript with React)."
      },
      learnProgramming: {
        title: "Learn Programming",
