  ...
  return (
    <div className="background">
      <div className="ContentSubPage">
        ...
        <br />
        <span className="contentHeadline">Rechtsgrundlagen</span>
        <br />
        <br />
        <p className="contentContent">
        ...
        <br />
        <span className="contentHeadline">Speicherdauer</span>
        <br />
        <br />
        <p className="contentContent">
        ...
        <br />
        <p className="contentContent">
          <strong>Landesbeauftragter für Datenschutz:</strong> Albert Cohaus
          (V.i.A.)
          <br />
          <strong>Adresse: </strong>Leiterstraße 9, 39104 Magdeburg
          <br />
          <strong>Telefonnr.:</strong> 03 91/818 03-0
          <br />
          <strong>E-Mail-Adresse:</strong> poststelle@lfd.sachsen-anhalt.de
          <br />
        ...
        <p className="contentContent">
          ...
          personenbezogene Daten auf unerwartete Weise verarbeitet und
          gespeichert werden.
        </p>
        <br />
        <p className="contentContent">
        ...
        <br />
        <span className="contentHeadline">TLS-Verschlüsselung mit https</span>
        <br />
        <br />
        <p className="contentContent">
        ...
        <br />
        <span className="contentHeadline">Webhosting Einleitung</span>
        <br />
        <br />
        <span className="contentContent">Webhosting Zusammenfassung</span>
        <br /><br/>
        <ol className="list-disc list-inside">
                <li>Betroffene: Besucher der Website</li>
                <li>Zweck: professionelles Hosting der Website und
                Absicherung des Betriebs</li>
                <li>Verarbeitete Daten: IP-Adresse, Zeitpunkt des
                Websitebesuchs, verwendeter Browser und weitere Daten. Mehr
                Details dazu finden Sie weiter unten bzw. beim jeweils
                eingesetzten Webhosting Provider.</li>
                <li>Speicherdauer: abhängig vom jeweiligen Provider, aber
                in der Regel 2 Wochen</li>
                <li>Rechtsgrundlagen: Art. 6 Abs. 1 lit.f DSGVO
                (Berechtigte Interessen)</li>
        </ol>
        <br />
        <span className="contentContent">Was ist Webhosting?</span>
        <br />
        <br />
        <p className="contentContent">
        ...
        <br />
        <br />
        <p className="contentContent">Die Zwecke der Datenverarbeitung sind:</p>
        <ol className="list-decimal list-inside">
          <li>
        ...
        <br />
        <span className="contentContent">Welche Daten werden verarbeitet?</span>
        <br />
        <br />
        <p className="contentContent">
        ...
        <br />
        <span className="contentContent">Rechtsgrundlage</span>
        <br />
        <br />
        <p className="contentContent">
        ...
        <p className="contentContent">
          ...
          dorthin verwendet GitHub sogenannte Standardvertragsklauseln (= Art.
          ...
          gespeichert werden. Durch diese Klauseln verpflichtet sich GitHub, bei
        ...
        <br />
        <p className="contentContent">
          Die GitHub Datenverarbeitungsbedingungen (Processing Terms), welche
        ...
        <br />
        <span className="contentHeadline">Namecheap Datenschutzerklärung</span>
        <br />
        <br />
        <p className="contentContent">
          Wir verwenden für unsere Website den Webhosting-Dienst Namecheap.
          Dienstanbieter ist das amerikanische Unternehmen Namecheap Inc., 4600
          East Washington Street Suite 305, Phoenix, AZ 85034, USA.
        </p>
        <br />
        <p className="contentContent">
          Namecheap verarbeitet Daten von Ihnen u.a. auch in den USA. Wir weisen
          darauf hin, dass nach Meinung des Europäischen Gerichtshofs derzeit
          kein angemessenes Schutzniveau für den Datentransfer in die USA
          besteht. Dies kann mit verschiedenen Risiken für die Rechtmäßigkeit
          und Sicherheit der Datenverarbeitung einhergehen.
        ...
        <br />
        <p className="contentContent">
          Die Namecheap Datenverarbeitungsbedingungen (Processing Terms), welche
          den Standardvertragsklauseln entsprechen, finden Sie unter{" "}
